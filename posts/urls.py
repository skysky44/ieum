...
urlpatterns = [
    ...
    path('<int:post_pk>/post_report',views.post_report, name='post_report'),
    path('<int:post_pk>/anonymous_post_report',views.anonymous_post_report, name='anonymous_post_report'),
    ...
    path('<int:post_pk>/comments/<int:comment_pk>/anonymous_comment_report/', views.anonymous_comment_report, name='anonymous_comment_report'),
